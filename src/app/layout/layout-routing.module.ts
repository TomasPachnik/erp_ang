...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {path: 'suppliers/supplier-detail/:uuid', loadChildren: './supplier-detail/supplier-detail.module#SupplierDetailModule'},
      {path: 'suppliers/newSupplier', loadChildren: './supplier-detail/supplier-detail.module#SupplierDetailModule'},
